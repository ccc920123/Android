...
import com.cncyj.mostbrain.game.fastcut.bn.object.BNPolyObject;
import com.cncyj.mostbrain.game.fastcut.bn.object.BNView;
import com.cncyj.mostbrain.game.fastcut.bn.util.box2d.Box2DUtil;
import com.cncyj.mostbrain.game.fastcut.bn.util.box2d.MyContactFilter;
import com.cncyj.mostbrain.game.fastcut.bn.util.constant.Constant;
import com.cncyj.mostbrain.game.fastcut.bn.util.constant.GeoLibUtil;
import com.cncyj.mostbrain.game.fastcut.bn.util.constant.GeometryConstant;
import com.cncyj.mostbrain.game.fastcut.bn.util.constant.MatrixState;
import com.cncyj.mostbrain.game.fastcut.bn.util.constant.MyFCData;
import com.cncyj.mostbrain.game.fastcut.bn.util.constant.ParticleConstant;
import com.cncyj.mostbrain.game.fastcut.bn.util.constant.SwitchIndex;
import com.cncyj.mostbrain.game.fastcut.bn.util.constant.isCutUtil;
import com.cncyj.mostbrain.game.fastcut.bn.util.manager.ShaderManager;
import com.cncyj.mostbrain.game.fastcut.bn.util.manager.TextureManager;
import com.cncyj.mostbrain.game.fastcut.bn.util.snow.ParticleForDraw;
import com.cncyj.mostbrain.game.fastcut.bn.util.snow.ParticleSystem;
...
//					System.exit(0);//退出游戏
			    	...
			    	itt.setClass(activity,MoreActivity.class);
	...
	class SelectTouchTask
	{
		void doTask(MotionEvent e)
		{
			...
			case MotionEvent.ACTION_DOWN:
				x=Constant.fromRealScreenXToStandardScreenX(e.getX());//将当前屏幕坐标转换为标准屏幕坐标
				y=Constant.fromRealScreenYToStandardScreenY(e.getY());
				if(x>=Constant.LevelView_Back_Left_X&&x<=Constant.LevelView_Back_Right_X&&
				y>=Constant.LevelView_Back_Top_Y&&y<=Constant.LevelView_Back_Bottom_Y)//点击返回按钮 则回到首界面
				{
					isDrawSnow=false;
					switchIndex=SwitchIndex.MainFrame;
					setPressSoundEffect("switchpane.ogg");//播放按键音
				}
				if(x>=Constant.LevelView_Series1_Left_X&&x<=Constant.LevelView_Series1_Right_X&&
						y>=Constant.LevelView_Series1_Top_Y&&y<=Constant.LevelView_Series1_Bottom_Y)//如果选择了第一小关
				{
				...
				}else if(x>=Constant.LevelView_Series2_Left_X&&x<=Constant.LevelView_Series2_Right_X&&
						y>=Constant.LevelView_Series2_Top_Y&&y<=Constant.LevelView_Series2_Bottom_Y)//如果选择了第二小关
				{
				...
				}else if(x>=Constant.LevelView_Series3_Left_X&&x<=Constant.LevelView_Series3_Right_X&&
						y>=Constant.LevelView_Series3_Top_Y&&y<=Constant.LevelView_Series3_Bottom_Y)//如果选择了第三小关
				{
	...
	class FirstLevelTouchTask
	{
		void doTask(MotionEvent e)
		{
			...
			case MotionEvent.ACTION_DOWN:
				...
				y=Constant.fromRealScreenYToStandardScreenY(e.getY());
				if(x>=Constant.LevelView_Back_Left_X&&x<=Constant.LevelView_Back_Right_X&&
				y>=Constant.LevelView_Back_Top_Y&&y<=Constant.LevelView_Back_Bottom_Y)//点击返回按钮 则回到选关界面
				{
					isDrawSnow=true;
					initSnow();//初始化雪花数据
					switchIndex=SwitchIndex.SelectFrame;
					setPressSoundEffect("switchpane.ogg");//播放按键音
				}else if(x>=Constant.LevelView_PickUp1_1_Left_X&&x<=Constant.LevelView_PickUp1_1_Right_X&&
						y>=Constant.LevelView_PickUp1_1_Top_Y&&y<=Constant.LevelView_PickUp1_1_Bottom_Y)//选择第一大关的第一小关
				{
					setPressSoundEffect("switchpane.ogg");//播放按键音
				...
				}else if(x>=Constant.LevelView_PickUp1_2_Left_X&&x<=Constant.LevelView_PickUp1_2_Right_X&&
						y>=Constant.LevelView_PickUp1_2_Top_Y&&y<=Constant.LevelView_PickUp1_2_Bottom_Y)//选择第一大关的第二小关
				{
					setPressSoundEffect("switchpane.ogg");//播放按键音
		...
		void doTask(MotionEvent e)
		{
			...
			case MotionEvent.ACTION_DOWN:
				...
				y>=Constant.LevelView_Back_Top_Y&&y<=Constant.LevelView_Back_Bottom_Y)//点击返回按钮 则回到选关界面
				{
					...
					initSnow();//初始化雪花数据
					switchIndex=SwitchIndex.SelectFrame;
				}else if(x>=Constant.LevelView_PickUp2_1_Left_X&&x<=Constant.LevelView_PickUp2_1_Right_X&&
						y>=Constant.LevelView_PickUp2_1_Top_Y&&y<=Constant.LevelView_PickUp2_1_Bottom_Y)//选择第二大关的第一小关
				{
					setPressSoundEffect("switchpane.ogg");//播放按键音
					...
					gameST=System.currentTimeMillis();
					switchIndex=SwitchIndex.GameViewFrame;
				}else if(x>=Constant.LevelView_PickUp2_2_Left_X&&x<=Constant.LevelView_PickUp2_2_Right_X&&
						y>=Constant.LevelView_PickUp2_2_Top_Y&&y<=Constant.LevelView_PickUp2_2_Bottom_Y)//选择第二大关的第二小关
				{
					setPressSoundEffect("switchpane.ogg");//播放按键音
		...
		void doTask(MotionEvent e)
		{
			...
			case MotionEvent.ACTION_DOWN:
				...
				y>=Constant.LevelView_Back_Top_Y&&y<=Constant.LevelView_Back_Bottom_Y)//点击返回按钮 则回到选关界面
				{
					...
					initSnow();//初始化雪花数据
					switchIndex=SwitchIndex.SelectFrame;
				}else if(x>=Constant.LevelView_PickUp3_1_Left_X&&x<=Constant.LevelView_PickUp3_1_Right_X&&
						y>=Constant.LevelView_PickUp3_1_Top_Y&&y<=Constant.LevelView_PickUp3_1_Bottom_Y)//选择第三大关的第一小关
				{
					setPressSoundEffect("switchpane.ogg");//播放按键音
					...
					gameST=System.currentTimeMillis();
					switchIndex=SwitchIndex.GameViewFrame;
				}else if(x>=Constant.LevelView_PickUp3_2_Left_X&&x<=Constant.LevelView_PickUp3_2_Right_X&&
						y>=Constant.LevelView_PickUp3_2_Top_Y&&y<=Constant.LevelView_PickUp3_2_Bottom_Y)//选择第三大关的第二小关
				{
					setPressSoundEffect("switchpane.ogg");//播放按键音
	...
	public void drawGameView()
	{
		...
		if(isWorldStep)//允许进行模拟
		{
			...
			{
				world.step(Constant.TIME_STEP, Constant.Vec_ITERA,Constant.POSITON_ITERA);//开始模拟
			}
		}else
		{
