package com.example.chenpan.library.util;
...
import com.example.chenpan.library.icons.MaterialDrawerFont;
...
public class DrawerUIUtils {
    ...
    public static int getSelectableBackground(Context ctx) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            ctx.getTheme().resolveAttribute( com.example.chenpan.library.R.attr.selectableItemBackground, outValue, true);
    ...
    public static int getOptimalDrawerWidth(Context context) {
        ...
        int maxDrawerWidth = context.getResources().getDimensionPixelSize( com.example.chenpan.library.R.dimen.material_drawer_width);
    ...
    public static Drawable getPlaceHolder(Context ctx) {
        return new IconicsDrawable(ctx, MaterialDrawerFont.Icon.mdf_person).colorRes( com.example.chenpan.library.R.color.accent).backgroundColorRes( com.example.chenpan.library.R.color.primary).sizeDp(56).paddingDp(16);
    }
    ...
    public static void setDrawerVerticalPadding(View v) {
        int verticalPadding = v.getContext().getResources().getDimensionPixelSize( com.example.chenpan.library.R.dimen.material_drawer_vertical_padding);
