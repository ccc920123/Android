...
public class ToggleDrawerItem extends BasePrimaryDrawerItem<ToggleDrawerItem> {
    ...
    public int getLayoutRes() {
        return  com.example.chenpan.library.R.layout.material_drawer_item_toggle;
    }
    ...
    private static class ViewHolder extends BaseViewHolder {
        ...
        private ViewHolder(View view) {
            super(view);
            this.toggle = (ToggleButton) view.findViewById( com.example.chenpan.library.R.id.material_drawer_toggle);
        }
    }
