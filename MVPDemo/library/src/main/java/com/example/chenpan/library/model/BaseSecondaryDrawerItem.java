...
public abstract class BaseSecondaryDrawerItem<T> extends BaseDrawerItem<T> {
    ...
    protected int getColor(Context ctx) {
        int color;
        if (this.isEnabled()) {
            color = ColorHolder.color(getTextColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_secondary_text,  com.example.chenpan.library.R.color.material_drawer_secondary_text);
        } else {
    ...
    protected static class BaseViewHolder extends RecyclerView.ViewHolder {
        ...
        public BaseViewHolder(View view) {
            ...
            this.view = view;
            this.icon = (ImageView) view.findViewById( com.example.chenpan.library.R.id.material_drawer_icon);
            this.name = (TextView) view.findViewById( com.example.chenpan.library.R.id.material_drawer_name);
            this.description = (TextView) view.findViewById( com.example.chenpan.library.R.id.material_drawer_description);
        }
    }
}
