...
import com.example.chenpan.library.interfaces.OnCheckedChangeListener;
...
public class SwitchDrawerItem extends BasePrimaryDrawerItem<SwitchDrawerItem> {
    ...
    public int getLayoutRes() {
        return  com.example.chenpan.library.R.layout.material_drawer_item_switch;
    }
    ...
    private static class ViewHolder extends BaseViewHolder {
        ...
        private ViewHolder(View view) {
            super(view);
            this.switchView = (SwitchCompat) view.findViewById( com.example.chenpan.library.R.id.material_drawer_switch);
        }
    }
