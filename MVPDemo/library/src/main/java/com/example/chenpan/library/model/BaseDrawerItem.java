package com.example.chenpan.library.model;
...
import com.example.chenpan.library.holder.ColorHolder;
import com.example.chenpan.library.holder.ImageHolder;
import com.example.chenpan.library.holder.StringHolder;
import com.example.chenpan.library.model.interfaces.Iconable;
import com.example.chenpan.library.model.interfaces.Nameable;
import com.example.chenpan.library.model.interfaces.Tagable;
import com.example.chenpan.library.model.interfaces.Typefaceable;
import com.example.chenpan.library.util.DrawerUIUtils;
...
public abstract class BaseDrawerItem<T> extends AbstractDrawerItem<T> implements Nameable<T>, Iconable<T>, Tagable<T>, Typefaceable<T> {
    ...
    protected int getSelectedColor(Context ctx) {
        return ColorHolder.color(getSelectedColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_selected,  com.example.chenpan.library.R.color.material_drawer_selected);
    }
    ...
    protected int getColor(Context ctx) {
        int color;
        if (this.isEnabled()) {
            color = ColorHolder.color(getTextColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_primary_text,  com.example.chenpan.library.R.color.material_drawer_primary_text);
        } else {
            color = ColorHolder.color(getDisabledTextColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_hint_text,  com.example.chenpan.library.R.color.material_drawer_hint_text);
        }
        return color;
    }
    ...
    protected int getSelectedTextColor(Context ctx) {
        return ColorHolder.color(getSelectedTextColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_selected_text,  com.example.chenpan.library.R.color.material_drawer_selected_text);
    }
    ...
    public int getIconColor(Context ctx) {
        int iconColor;
        if (this.isEnabled()) {
            iconColor = ColorHolder.color(getIconColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_primary_icon,  com.example.chenpan.library.R.color.material_drawer_primary_icon);
        } else {
            iconColor = ColorHolder.color(getDisabledIconColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_hint_icon,  com.example.chenpan.library.R.color.material_drawer_hint_icon);
        }
        return iconColor;
    }
    ...
    protected int getSelectedIconColor(Context ctx) {
        return ColorHolder.color(getSelectedIconColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_selected_text,  com.example.chenpan.library.R.color.material_drawer_selected_text);
    }
