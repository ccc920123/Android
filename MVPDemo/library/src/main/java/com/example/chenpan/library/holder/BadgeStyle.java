...
import com.example.chenpan.library.model.utils.BadgeDrawableBuilder;
...
public class BadgeStyle {
    private int mGradientDrawable = com.example.chenpan.library.R.drawable.material_drawer_badge;
