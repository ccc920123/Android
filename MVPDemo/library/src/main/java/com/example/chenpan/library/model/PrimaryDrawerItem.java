...
import com.example.chenpan.library.model.interfaces.ColorfulBadgeable;
...
public class PrimaryDrawerItem extends BasePrimaryDrawerItem<PrimaryDrawerItem> implements ColorfulBadgeable<PrimaryDrawerItem> {
    ...
    public int getLayoutRes() {
        return  com.example.chenpan.library.R.layout.material_drawer_item_primary;
    }
    ...
    private static class ViewHolder extends BaseViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            this.badgeContainer = view.findViewById( com.example.chenpan.library.R.id.material_drawer_badge_container);
