...
public class DrawerItemViewHelper {
    ...
    public View build() {
        ...
        if (mDivider) {
            ...
            divider.setBackgroundColor(UIUtils.getThemeColorFromAttrOrRes(mContext, com.example.chenpan.library.R.attr.material_drawer_divider,com.example.chenpan.library.R.color.material_drawer_divider));
