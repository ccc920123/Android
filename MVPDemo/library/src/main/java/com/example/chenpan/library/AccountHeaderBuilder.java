package com.example.chenpan.library;
...
import com.example.chenpan.library.holder.DimenHolder;
...
import com.example.chenpan.library.util.IdDistributor;
import com.example.chenpan.library.view.BezelImageView;
...
public class AccountHeaderBuilder {
     ...
     * Overrides typeface supplied to {@link AccountHeaderBuilder#withTypeface(Typeface)}
     *
     * @param typeface
     * @return
     * @see #withTypeface(Typeface)
     */
