...
import com.example.chenpan.library.model.utils.ViewHolderFactory;
import com.example.chenpan.library.util.DrawerImageLoader;
...
public class ProfileDrawerItem extends AbstractDrawerItem<ProfileDrawerItem> implements IProfile<ProfileDrawerItem>, Tagable<ProfileDrawerItem>, Typefaceable<ProfileDrawerItem> {
    ...
    public int getLayoutRes() {
        return  com.example.chenpan.library.R.layout.material_drawer_item_profile;
    }
    ...
    public void bindView(RecyclerView.ViewHolder holder) {
        ...
        int selectedColor = ColorHolder.color(getSelectedColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_selected,  com.example.chenpan.library.R.color.material_drawer_selected);
        //get the correct color for the text
        int color = ColorHolder.color(getTextColor(), ctx,  com.example.chenpan.library.R.attr.material_drawer_primary_text,  com.example.chenpan.library.R.color.material_drawer_primary_text);
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ViewHolder(View view) {
            super(view);
            this.view = view;
            this.profileIcon = (ImageView) view.findViewById( com.example.chenpan.library.R.id.material_drawer_profileIcon);
            this.name = (TextView) view.findViewById( com.example.chenpan.library.R.id.material_drawer_name);
            this.email = (TextView) view.findViewById( com.example.chenpan.library.R.id.material_drawer_email);
        }
    }
}
