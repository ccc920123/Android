...
public class MiniDrawerItem extends BaseDrawerItem<MiniDrawerItem> {
    ...
    public int getLayoutRes() {
        return  com.example.chenpan.library.R.layout.material_drawer_item_mini;
    }
    ...
    public void bindView(RecyclerView.ViewHolder holder) {
        ...
        int verticalPadding = ctx.getResources().getDimensionPixelSize( com.example.chenpan.library.R.dimen.material_drawer_padding);
        int topBottomPadding = ctx.getResources().getDimensionPixelSize( com.example.chenpan.library.R.dimen.material_mini_drawer_item_padding);
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            this.badge = (TextView) view.findViewById( com.example.chenpan.library.R.id.material_drawer_badge);
        }
    }
}
