...
import com.jysd.cartoonapp.view.activity.MorePicActivity;
...
//                我们要跳转activity
                Intent intent = new Intent(mContext, MorePicActivity.class);
...
//                Toast.makeText(mContext, "漫画详情界面界面", Toast.LENGTH_SHORT).show();
    ...
    public void setData(Juzimi mData) {
        ...
        if (TextUtils.isEmpty(mData.content)) {
            ...
            tv_content.setText(mData.content+"["+mData.item+"]");
        }
