...
import com.jysd.cartoonapp.adapter.ArticleAdapter;
import com.jysd.cartoonapp.adapter.ArticleChildAdapter;
import com.jysd.cartoonapp.adapter.ArticleJokeAdapter;
import com.jysd.cartoonapp.adapter.FragmentAdapter;
import com.jysd.cartoonapp.adapter.JuzimiAdapter;
import com.jysd.cartoonapp.adapter.JuzimiAdapter2;
    ...
    public void bindView(Bundle savedInstanceState) {
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName(R.string.drawer_item_non_translucent_status_drawer).withIcon(R.mipmap.g).withIdentifier(2).withSelectable(true).withBadgeStyle(new BadgeStyle().withTextColor(Color.WHITE).withColorRes(R.color.md_red_700)),
