...
import com.jysd.cartoonapp.presenter.ArticleFragmentPresenter;
import com.jysd.cartoonapp.utils.NetWorkUtil;
import com.jysd.cartoonapp.view.holder.ArticleHolder;
...
public class ArticleFragment extends BaseFragment implements IArticleFragmentView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void bindView(Bundle savedInstanceState) {
        ...
        ((ArticleFragmentPresenter) mPresenter).getArticles(params);//搭建桥梁
    }
