...
import com.jysd.cartoonapp.bean.Episode;
...
import com.jysd.cartoonapp.bean.VideoSources;
import com.jysd.cartoonapp.bean.Videos;
import com.jysd.cartoonapp.bean.YouKu;
import com.jysd.cartoonapp.model.PlayModel;
import com.jysd.cartoonapp.model.impl.IPlayModel;
import com.jysd.cartoonapp.utils.StringUtils;
import com.jysd.cartoonapp.view.impl.IPlayView;
...
public class PlayPresenter extends BasePresenter<IPlayView> {
    ...
    public void getYoukuVideoInfo(Map<String, String> params) {
        mIPlayModel.parseYoukuHtml(params, new com.jysd.cartoonapp.inter.Callback<YouKu>() {
