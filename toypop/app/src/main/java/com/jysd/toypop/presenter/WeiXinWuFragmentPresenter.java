...
import com.jysd.toypop.model.WenXinWuFragmentModel;
 ...
 */
public class WeiXinWuFragmentPresenter extends BasePresenter<IArticleFragmentView> {
    private WenXinWuFragmentModel mIArticleModel;

    public WeiXinWuFragmentPresenter() {
        mIArticleModel = new WenXinWuFragmentModel();//model获取数据
