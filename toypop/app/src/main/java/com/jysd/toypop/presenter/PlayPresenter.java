...
import com.jysd.toypop.bean.Episode;
import com.jysd.toypop.bean.Episodes;
import com.jysd.toypop.bean.PlayAddress;
import com.jysd.toypop.bean.PlayUrl;
import com.jysd.toypop.bean.VideoSources;
import com.jysd.toypop.bean.Videos;
import com.jysd.toypop.bean.YouKu;
import com.jysd.toypop.model.PlayModel;
import com.jysd.toypop.model.impl.IPlayModel;
import com.jysd.toypop.utils.StringUtils;
import com.jysd.toypop.view.impl.IPlayView;
...
public class PlayPresenter extends BasePresenter<IPlayView> {
    ...
    public void getYoukuVideoInfo(Map<String, String> params) {
        mIPlayModel.parseYoukuHtml(params, new com.jysd.toypop.inter.Callback<YouKu>() {
