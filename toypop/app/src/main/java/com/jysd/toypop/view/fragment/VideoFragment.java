...
import com.jysd.toypop.ConstantValue;
...
import com.jysd.toypop.presenter.VideoPresenter;
import com.jysd.toypop.utils.MD5Utils;
import com.jysd.toypop.utils.NetWorkUtil;
import com.jysd.toypop.view.holder.ListOfVideoHolder;
import com.jysd.toypop.view.holder.VideoHolder;
import com.jysd.toypop.view.impl.IVideoView;
...
public class VideoFragment extends BaseFragment implements IVideoView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void bindView(Bundle savedInstanceState) {
        fl_loading.withLoadedEmptyText("≥﹏≤ , 连条毛都没有 !").withEmptyIco(R.mipmap.movie_store_empty_view).withBtnEmptyEnnable(false)
