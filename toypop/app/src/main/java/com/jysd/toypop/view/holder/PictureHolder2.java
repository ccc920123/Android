...
import com.jysd.toypop.view.activity.CartoonDetail;
 ...
 */
public class PictureHolder2 extends BaseHolder<Juzimi> {
    public PictureHolder2(View view) {
        super(view);
    }
...
//                我们要跳转activity
                Intent intent = new Intent(mContext, CartoonDetail.class);
    ...
    public void showPop() {
        onMeasure();
        View view = ContextUtils.inflate(mContext, R.layout.pop_picture2);
    ...
    public void setData(Juzimi mData) {
        ...
        FrecsoUtils.loadImage(mData.sender, sd_juzimi);
    }
}
