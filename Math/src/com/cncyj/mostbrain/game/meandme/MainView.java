package com.cncyj.mostbrain.game.meandme;
...
public class MainView extends View {
    ...
    private void drawInstructions(Canvas canvas) {
        ...
        StaticLayout layout = new StaticLayout(getResources().getString(R.string.instructions),
        		paint,DisplayMetricsEN.getWidth(), 
        		Alignment.ALIGN_NORMAL, 1.0F, 0.0F, true);  
        canvas.save();  
        canvas.translate(startingX, endingY - textShiftY + textPaddingSize);//从20，20开始画  
        layout.draw(canvas);  
