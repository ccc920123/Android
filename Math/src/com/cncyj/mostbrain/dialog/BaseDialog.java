...
public class BaseDialog extends Dialog implements
	...
	public static BaseDialog getDialog(Context context, int titleId,
			CharSequence message) {
		return getDialog(context, titleId, message, null, null, null, null, null,
				null);
	}
	...
	public static BaseDialog getDialog(Context context, int titleId,
		...
		return getDialog(context, titleId, message, button1, listener1, null,
				null, null, null);
	}
	...
	public static BaseDialog getDialog(Context context, int titleId,
		...
		return getDialog(context, titleId, message, button1, listener1, button2,
				listener2, null, null);
	}
	public static BaseDialog getDialog(Context context, int titleId,
			CharSequence message, CharSequence button1,
			DialogInterface.OnClickListener listener1, CharSequence button2,
			DialogInterface.OnClickListener listener2,boolean b) {
		return getDialog(context, titleId, message, button1, listener1, button2,
				listener2, null, null,b);
	}
	...
	public static BaseDialog getDialog(Context context, int titleId,
			...
			DialogInterface.OnClickListener listener1, CharSequence button2,
			DialogInterface.OnClickListener listener2, CharSequence button3,
			DialogInterface.OnClickListener listener3,boolean b) {
		mBaseDialog = new BaseDialog(context);
		if (mBaseDialog.titleAndMessageIsExist(titleId, message)) {
			mBaseDialog.setTitle(titleId);
			mBaseDialog.setMessage(message);
	...
	public boolean titleAndMessageIsExist(int titleId,
			CharSequence message) {
