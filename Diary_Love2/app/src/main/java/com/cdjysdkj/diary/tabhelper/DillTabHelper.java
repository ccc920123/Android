...
public class DillTabHelper {
     ...
     * @return
     */
    public int deleteTime(String Time) {
        try {
            DeleteBuilder<DillTab, String> deleteBuilder = dillDao.deleteBuilder();
            deleteBuilder.where().eq("time", Time);
    ...
    public int deleteDesDays(String id) {
        try {
            DeleteBuilder<DillTab, String> deleteBuilder = dillDao.deleteBuilder();
