...
public class PasswordActivity extends BaseHomeActivity {
    ...
    private void init() {
        ...
        if (isfirst) {//true
            ...
            mTextWjmm.setVisibility(View.GONE);//隐藏
        }
    ...
    private void getview() {
        ...
        mTextWjmm = (TextView) findViewById(R.id.wjma);
        ...
        mTextWjmm.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG);
        mTextWjmm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent itt = new Intent();
                itt.setClass(PasswordActivity.this, ResetPaswordActivity.class);
                itt.putExtra("first", isfirst);
                itt.putExtra("from","password");
                startActivity(itt);
                finish();
            }
        });
